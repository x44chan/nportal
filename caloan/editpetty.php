      ...
      <div class="row">
            <div class="col-xs-3 col-xs-offset-3">
                  ...
                  <select class="form-control" name = "pettype" required>
                        ...
                        <option <?php if($row['projtype'] == 'Company Vehicle'){ echo ' selected ';} ?> value="Company Vehicle"> Company Vehicle </option>
                        <option <?php if($row['projtype'] == 'Social Payments'){ echo ' selected ';} ?> value="Social Payments"> Social Payments </option>
                        <?php if($_SESSION['acc_id'] == '37') {  ?>
                              <option <?php if($row['projtype'] == 'House'){ echo ' selected ';} ?>value="House"> House </option>
                        <?php } ?>
                  </select>
            </div>
            <div <?php if($row['projtype'] != 'Company Vehicle'){ echo ' style = "display: none;" ';} ?> class="col-xs-4"  id = "com_car">
                  <div  class="form-group">
                        <label>Company Vehicle <font color = "red">*</font></label>
                        <select class="form-control" name = "com_car">
                              <option value = ""> - - - - - </option>
                              <option <?php if($row['project'] == 'Mitsubishi L300-NJ 9174'){ echo ' selected '; } ?> value="Mitsubishi L300-NJ 9174"> Mitsubishi L300-NJ 9174 </option>
                              <option <?php if($row['project'] == 'Mitsubishi L300-WMO 916'){ echo ' selected '; } ?> value="Mitsubishi L300-WMO 916"> Mitsubishi L300-WMO 916 </option>
                              <option <?php if($row['project'] == "Mitsubishi L300-ABL3130"){ echo ' selected '; } ?> value="Mitsubishi L300-ABL3130"> Mitsubishi L300-ABL3130 </option>
                              <option <?php if($row['project'] == "Honda City DV 0616"){ echo ' selected '; } ?> value="Honda City DV 0616"> Honda City DV 0616 </option>
                              <option <?php if($row['project'] == "Ford Everest- UQZ 974"){ echo ' selected '; } ?> value="Ford Everest- UQZ 974"> Ford Everest- UQZ 974 </option>
                        </select>
                  </div>
            </div>
            <div <?php if($row['projtype'] != 'Social Payments'){ echo ' style = "display: none;" ';} ?> class="col-xs-4"  id = "social">
                  <div  class="form-group">
                        <label>Social Payments <font color = "red">*</font></label>
                        <select class="form-control" name = "social">
                              <option value = ""> - - - - - </option>
                              <option <?php if($row['project'] == 'SSS'){ echo ' selected '; } ?>value="SSS"> SSS </option>
                              <option <?php if($row['project'] == 'Phic'){ echo ' selected '; } ?>value="Phic"> Phic </option>
                              <option <?php if($row['project'] == 'HDMF'){ echo ' selected '; } ?>value="HDMF"> HDMF </option>
                        </select>
                  </div>
            </div>
            ...
            <div <?php if($row['comtype'] != 'Bidding'){ echo ' style = "display: none;" ';} ?> class="col-xs-4"  id = "comisionbid">
                  <div  class="form-group">
            ...
            <div <?php if($row['comtype'] != 'Project'){ echo ' style = "display: none;" ';} ?> class="col-xs-4"  id = "comisionproj">
                  <div  class="form-group">
...
echo '</div>';
      ...
      if(isset($_POST['uppetty'])){
            ...
            if($_POST['pettype'] == "" || ($_POST['pettype'] != 'Netlink' && $_POST['pettype'] != 'Luwas' && $_POST['pettype'] != 'Supplier' && $_POST['pettype'] != 'Permit & Licenses Netlink' && $_POST['pettype'] != 'Commission Base' && $project == "")){
